...
//Tests:
// var code = "3,9,8,9,10,9,4,9,99,-1,8";
// console.log((runProgram(code, 8)===1))
// console.log((runProgram(code, 7)===0))

// var code = "3,9,7,9,10,9,4,9,99,-1,8";
// console.log((runProgram(code, 7)===1))
// console.log((runProgram(code, 8)===0))


// var code = "3,3,1108,-1,8,3,4,3,99";
// console.log((runProgram(code, 8)===1))
// console.log((runProgram(code, 7)===0))

// var code = "3,3,1107,-1,8,3,4,3,99";
// console.log((runProgram(code, 7)===1))
// console.log((runProgram(code, 8)===0))

// code = "3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9";
// console.log((runProgram(code, 0)===0));
// console.log((runProgram(code, 1)===1));
...
// console.log((runProgram(code, 7)===999));
// console.log((runProgram(code, 8)===1000));
// console.log((runProgram(code, 9)===1001));
