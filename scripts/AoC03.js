var calculatePaths = function (line1, line2, grid) {
    ...
    var moveLine = function (direction, amount, cursor, grid, lineValue) {
        ...
        var setGridValue = function (grid, cursor) {
            ...
            if (grid[cursor[0]][cursor[1]] < lineValue) {
                grid[cursor[0]][cursor[1]] += lineValue
            }
        };
    ...
    return calculateDistance(grid, 3);
}
...
console.log("distance: %d", calculatePaths(line1, line2, grid));
